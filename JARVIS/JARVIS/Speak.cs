...
namespace JARVIS
{
    public class Speak
    {
        ...
        {
            JARVIS.Speak("No Appointments found sir");
        }

        public void getPapers(string subject)
        {
            JARVIS.Speak("Would you like me to find the papers for " + subject);
        }

        public void whatSubject()
        {
            JARVIS.Speak("What subject are you revising");
        }

        public void noPapers()
        {
            JARVIS.Speak("Papers declined");
        }
        ...
        public void operationConfirm(string choice)
        {
            JARVIS.Speak("Are you sure you want to " + choice + " the computer");
        }

        public void cancelOperation(string choice)
        {
            JARVIS.Speak(choice + " canceled");
        }
        ...
        public void sayToDo(string[] toDoList)
        {
            JARVIS.Speak("Current items on the to do list are: ");
        ...
        {
            JARVIS.Speak("Do you want to read or write to the file?");
        }

        public void write()
        {
            JARVIS.Speak("What do you want to write?");
        }

        public void wrote()
        {
            JARVIS.Speak("File successfully wrote");
        }
